...
class MovieCard extends HTMLElement{
    constructor(){
        ...
        //Read Attribute Info
        // Birden fazla component varsa ya da components icindeki kodlar artmaya basladigi zaman ,shadowDom buyumeye basladigi zaman 
        // burada set edilen attribute ile Doma yuklenmesi arasindaki surede cekilemiyor(calistirilamiyor)
        // yani constructor cok daha hizli calisiiyorr.
        //setTimeout 100!!! (trick)    
        setTimeout(() => {
            ...
            this.shadowRoot.querySelector(".button").setAttribute("href",`https://www.imdb.com/title/${this.getAttribute("imdbID")}`);
